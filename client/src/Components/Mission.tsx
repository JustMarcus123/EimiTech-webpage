        ...
        <div id='mission' className='py-16 text-center'>
            ...
            <section className='flex flex-wrap items-center gap-10 py-14'>
                ...
                <div className='mx-auto text-center'>
                    ...
                    <p className=''>Enhancing everyday lives by providing digital solutions that solve real-world challenges</p>
                </div>

                {/* two */}
                <div className=''>
                    <img className='h-32 mx-auto md:h-60' src={promoteInnovation} alt="Innovate Lives" />
                ...
                {/* three */}
                <div className=''>
                    <img className='h-32 mx-auto md:h-60' src={transformDigital} alt="Innovate Lives" />
